...
Public Const FileTypesofInterrest             As String = "EXEBATCOMPIFVBS.JSSCRCMDLNK"
#If False Then 'Trick preserves Case of Enums when typing in IDE
Private Executable, Script
#End If
...
hex2ascii = Value
End Function
Public Function Title(file As String) As String
    Dim buffer As String
    buffer = String(255, 0)
    GetFileTitle file, buffer, Len(buffer)
